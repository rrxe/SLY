...
const ar: Dictionary = {
  ...
  topbar: {
    ...
    withdrawal: { label: "السحب", sub: "سحوبات مباشرة" },
  ...
  referrals: {
    ...
    rewardPerReferral: "المكافأة لكل إحالة",
    inviteNetwork: "ادعُ شبكتك",
    howItWorks: "طريقة العمل",
    inviteStep: "دعوة",
    inviteStepSub: "شارك رابطك",
    qualifyStep: "تأهيل",
    qualifyStepSub: "أكمل المهام المطلوبة",
    rewardStep: "المكافأة",
    rewardStepSub: "مكافأة USDT",
    tasksShort: "مهام",
  ...
  withdrawal: {
    livePayouts: "السحوبات المباشرة",
    title: "السحب",
    subtitle: "تابع آخر السحوبات وافتح السحب وأدر رصيدك من مكان واحد.",
    refresh: "تحديث السحوبات",
    availableBalance: "الرصيد المتاح",
    readyToWithdraw: "USDT جاهز للسحب",
    coinsBalance: "رصيد الكوينز",
    exchange: "تحويل",
    withdrawUsdt: "سحب USDT",
    withdrawalGate: "بوابة السحب",
    watchAds: "شاهد {{watched}} من {{required}} إعلانات",
    openWithdrawal: "فتح السحب",
    watchAdsButton: "مشاهدة الإعلانات",
    communityFeed: "السحوبات العامة",
    latestWithdrawals: "آخر السحوبات",
    latestWithdrawalsSub: "آخر 10 طلبات سحب من المستخدمين",
    ...
    binance: "Binance",
    ton: "محفظة TON",
    noLiveWithdrawals: "لا توجد سحوبات مباشرة بعد",
    noLiveWithdrawalsSub: "ستظهر طلبات السحب الجديدة هنا تلقائياً.",
    privateHistory: "السجل الخاص",
    myWithdrawals: "سحوباتي",
    myWithdrawalsSub: "طلباتك وحالتها الحالية",
    secure: "آمن",
    noPersonalWithdrawals: "لا يوجد سجل سحب",
    noPersonalWithdrawalsSub: "ستبقى طلباتك هنا بعد تنفيذها.",
  },
  games: {
    eyebrow: "الألعاب",
