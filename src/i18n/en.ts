...
const en = {
  ...
  topbar: {
    ...
    withdrawal: { label: "Withdrawal", sub: "Live payouts" },
  ...
  referrals: {
    ...
    inviteNetwork: "Invite your network",
    howItWorks: "HOW IT WORKS",
    inviteStep: "Invite",
    inviteStepSub: "Share your link",
    qualifyStep: "Qualify",
    qualifyStepSub: "Complete required tasks",
    rewardStep: "Reward",
    rewardStepSub: "USDT reward",
    tasksShort: "tasks",
  ...
  withdrawal: {
    ...
    title: "Withdrawal",
    subtitle: "Track live payouts, unlock your withdrawal, and manage your balance from one place.",
    refresh: "Refresh withdrawals",
    availableBalance: "Available balance",
    readyToWithdraw: "USDT available for payout",
    coinsBalance: "Coins balance",
    exchange: "Exchange",
    withdrawUsdt: "Withdraw USDT",
    withdrawalGate: "Withdrawal gate",
    watchAds: "Watch {{watched}} of {{required}} ads",
    openWithdrawal: "Open withdrawal",
    watchAdsButton: "Watch ads",
    communityFeed: "COMMUNITY FEED",
    latestWithdrawals: "Latest withdrawals",
    latestWithdrawalsSub: "The latest 10 public payout requests",
    ...
    binance: "Binance",
    ton: "TON Wallet",
    noLiveWithdrawals: "No live payouts yet",
    noLiveWithdrawalsSub: "New withdrawal requests will appear here automatically.",
    privateHistory: "PRIVATE HISTORY",
    myWithdrawals: "My withdrawals",
    myWithdrawalsSub: "Your own requests and their current status",
    secure: "Secure",
    noPersonalWithdrawals: "No withdrawal history",
    noPersonalWithdrawalsSub: "Your completed requests will stay available here.",
  },
  games: {
    eyebrow: "GAMES",
